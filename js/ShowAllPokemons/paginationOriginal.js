...
//new pagination almost workable
let page_index = 0;
...
//   next_btn.replaceWith(next_btn.cloneNode(true));
//   console.log(next_btn);
//   const dodo = document.querySelector(".next-btn");
//   dodo.innerHTML = "ASDSADADSAD";
...
//   prev_btn.replaceWith(prev_btn.cloneNode(true));
//   console.log(prev_btn);
//   prev_btn.addEventListener("click", () => {
//     page_index -= 1;
//     drawContentNavigation(
